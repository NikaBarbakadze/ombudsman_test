		...
		<div class="inside_menu">
			<div class="menu_item">
				<a href="#">
					...
					<strong>ზოგადი ინფორმაცია ადმინისტრაციული ორგანოს შესახებ</strong>
				</a>
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>საჯარო ინფორმაციის გვერდი</strong>
				</a>			
			</div>		
			<div class="menu_item">
				<a href="#">
					...
					<strong>ინფორმაცია ადმინისტრაციული ორგანოს საკადრო უზრუნველყოფის შესახებ</strong>
				</a>			
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>შესყიდვები და პრივატიზება</strong>
				</a>			
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>სამართლებრივი აქტები</strong>
				</a>			
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>სხვა საჯარო ინფორმაცია</strong>
				</a>			
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>მოითხოვე საჯარო ინფორმაცია</strong>
				</a>			
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>წერილობითი მოსაზრებები</strong>
				</a>			
			</div>																						
		</div>
