		...
		<div class="page_media page_attachments">
			...
			<ul>
				<li>
					...
					<a href="#" title="ფაილის დასახელების საცდელი ტექსტი" class="attachment_title" target="_blank">ფაილის დასახელების საცდელი ტექსტიფაილის დასახელების საცდელი ტექსტიფაილის დასახელების საცდელი ტექსტი</a>
					<a href="#" title="ჩამოტვირთვა" class="attachment_download" target="_blank">
				...
				<li>
					...
					<a href="#" title="ფაილის დასახელების საცდელი ტექსტი" class="attachment_title" target="_blank">ფაილის დასახელების საცდელი ტექსტი</a>
					<a href="#" title="ჩამოტვირთვა" class="attachment_download" target="_blank">
						<em class="fas fa-download"></em>
					</a>
				</li>
				...
				<li>
					<div class="file_type">
						<em class="fas fa-file-archive"></em>
					</div>
					<a href="#" title="ფაილის დასახელების საცდელი ტექსტი" class="attachment_title" target="_blank">ფაილის დასახელების საცდელი ტექსტი</a>
					<a href="#" title="ჩამოტვირთვა" class="attachment_download" target="_blank">
						<em class="fas fa-download"></em>
