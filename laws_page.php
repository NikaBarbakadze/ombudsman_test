		...
		<div class="inside_menu">
			<div class="menu_item">
				<a href="#">
					...
					<strong>საერთაშორისო აქტები</strong>
				</a>
			</div>
			<div class="menu_item">
				<a href="#">
					...
					<strong>ეროვნული კანონმდებლობა</strong>
				</a>			
			</div>		
			<div class="menu_item">
				<a href="#">
					...
					<strong>შიდა რეგულაციები</strong>
				</a>			
			</div>		
			<div class="menu_item">
				<a href="#">
